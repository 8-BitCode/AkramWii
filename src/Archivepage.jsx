...
const ARCHIVE_PROJECTS = [
  ...
  },
  {
    ...
    description: "My first proper group project at university - a satirical anti-gambling site where I handled a lot of the web design and the database. A lot of what I'd learned from the Algorithm Showcase went straight into this one. (Disclaimer: made only for desktop)",
