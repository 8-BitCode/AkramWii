...
const VOID = '#140a08';
const STONE = '#6b3a2f';
const STONE_LIGHT = '#a8583f';
const STONE_DARK = '#3d1f16';
const PANEL = '#2a1610';
const GOLD = '#ffd23f';
const CREAM = '#ffefad';
      ...
      >
        ...
        <div
          style={{
            ...
            borderStyle: 'solid',
            borderWidth: '3px',
            borderColor: `${VOID} ${STONE_LIGHT} ${STONE_LIGHT} ${VOID}`,
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <span
              style={{
                ...
                height: 7,
                background: GOLD,
                boxShadow: `0 0 0 2px ${VOID}, 0 0 6px 2px rgba(255,210,63,0.85)`,
